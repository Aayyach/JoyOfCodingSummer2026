...
public class AboutInnerClasses {
    ...
    public void creatingAnonymousInnerClasses() {
        ...
        // Because we're declaring a variable
    ...
    public void innerClassAndInheritance() {
        ...
        // someObject is of the type Inner class, not AboutInnerClasses
    ...
    public void innerClassAndInheritanceOther() {
        ...
        // True, since OtherInner extends AboutInnerClasses (Inheritance)
